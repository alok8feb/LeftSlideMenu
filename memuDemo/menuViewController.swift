...
class menuViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        ManuNameArray = ["Home","Message","Map","Logout"]
    ...
    override func viewWillAppear(_ animated: Bool) {
        //self.imgProfile.setRandomDownloadImage(100, height: 100)
        let imageurl = "http://lorempixel.com/100/100/";
        imgProfile.downloadedFrom(link: imageurl);
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if cell.lblMenuname.text! == "Logout"
        {
           print("setting Tapped")
            let refreshAlert = UIAlertController(title: "Logout", message: "Do you really want to logout?", preferredStyle: UIAlertControllerStyle.alert)
